...
from controllers.client_equipement import *
...
from controllers.admin_equipement import *
from controllers.admin_declinaison_equipement import *
from controllers.admin_commande import *
from controllers.admin_type_equipement import *
...
app.register_blueprint(client_equipement)
...
app.register_blueprint(admin_equipement)
app.register_blueprint(admin_declinaison_equipement)
app.register_blueprint(admin_commande)
app.register_blueprint(admin_type_equipement)
